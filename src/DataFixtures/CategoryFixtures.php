...
class CategoryFixtures extends Fixture
{
        ...
        public function __construct(SluggerInterface $slugger) // lorsqu'on va appeler la CategoryFixtures la fct va automatiquement se construire 
        {
           $this->slugger= $slugger;
        }     

        public function load(ObjectManager $manager): void // void cad ca ne retourne rien (vide , pas de return)
        {
           $categories = [
            'Politique',
            'société',
